...
export default function TodoApp({ initialTasks }: { initialTasks: any[] }) {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex justify-center px-4 py-12 font-sans relative">
      {/* Restored to max-w-md as per your previous UI */}
      <div className="w-full max-w-md">
        ...
        {/* MAIN CARD - Restored original padding and shadows */}
        <div className="bg-white rounded-3xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-50">
          ...
          {/* FOOTER */}
          <div className="flex justify-between items-center text-sm mt-8 pt-6 border-t border-gray-50">
      ...
      {/* TOAST - Positioned center using fixed bottom-0 left-1/2 */}
      <AnimatePresence>
        {toast && (
          <motion.div
            ...
            className="fixed bottom-0 left-1/2 z-50 bg-zinc-800 text-white px-6 py-3 rounded-2xl shadow-2xl flex items-center gap-3 min-w-[200px] justify-center"
          >
